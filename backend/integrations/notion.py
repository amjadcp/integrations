...
from integrations.integration_item import NotionItem
...
REDIRECT_URI = f'{ROOT_URL}/integrations/notion/oauth2callback'

authorization_url = f'https://api.notion.com/v1/oauth/authorize?client_id={CLIENT_ID}&response_type=code&owner=user&redirect_uri={quote(REDIRECT_URI)}'
...
def create_integration_item_metadata_object(
    ...
    integration_item_metadata = NotionItem(
        id=response_json['id'],
...
async def get_items(credentials) -> list[NotionItem]:
