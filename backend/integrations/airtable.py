...
from integrations.integration_item import AirtableItem
...
REDIRECT_URI = f'{ROOT_URL}/integrations/airtable/oauth2callback'

authorization_url = f'https://airtable.com/oauth2/v1/authorize?client_id={CLIENT_ID}&response_type=code&owner=user&redirect_uri={quote(REDIRECT_URI)}'
...
def create_integration_item_metadata_object(
    ...
    integration_item_metadata = AirtableItem(
...
async def get_items(credentials) -> list[AirtableItem]:
    credentials = json.loads(credentials)
